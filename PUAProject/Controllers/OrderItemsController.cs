...
namespace PUAProject.Controllers
{
    public class OrderItemsController : Controller
    {
        ...
        public OrderItemsController(PUA20832Context context)
        {
            _context = context;
        }
        ...
        {
            var pUA20832Context = _context.OrderItems.Include(o => o.Order).Include(o => o.Product);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PUA20832Context.OrderItems'  is null.");
            }
            var orderItem = await _context.OrderItems.FindAsync(id);
            if (orderItem != null)
            {
